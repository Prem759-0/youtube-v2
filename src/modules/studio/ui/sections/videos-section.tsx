  ...
  return (
    <div className="overflow-x-auto">
      ...
      <Table className="table-fixed w-full min-w-[1000px]">
        <TableHeader>
          <TableRow>
            <TableHead className="pl-6 w-[41%]">Video</TableHead>
            <TableHead className="w-[12%]">Visibility</TableHead>
            <TableHead className="w-[10%]">Status</TableHead>
            <TableHead className="w-[15%] pr-8">Date</TableHead>
            <TableHead className="w-[7%] pl-2 text-left">Views</TableHead>
            <TableHead className="w-[8%] pl-2 text-left">Comments</TableHead>
            <TableHead className="w-[7%] pl-2 text-left">Likes</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
